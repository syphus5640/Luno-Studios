...
const initCalendar = async () => {
  ...
  try {
    ...
    try {
      ...
      console.error(`\n❌ ERROR: Could not find calendar "${CALENDAR_ID}"`);
      console.error(`   ACTION REQUIRED: Share your calendar with: ${serviceAccountEmail}`);
      console.error('   Make sure to select "Make changes to events" permission.\n');
      calendar = null;
    }
